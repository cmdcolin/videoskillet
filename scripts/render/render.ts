...
// `videoskillet render in.mp4 out.mov` and `videoskillet in.mp4 out.mov` are
// the same command: rendering is what this program does unless another
// subcommand is named, and `main.ts` sends everything else here.
const args = Deno.args[0] === 'render' ? Deno.args.slice(1) : Deno.args
